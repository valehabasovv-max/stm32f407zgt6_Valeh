...
// 7x10 Font Data (daha yaxşı oxunaqlılıq)
...
// Font structure for 7x10
const Font_t font_7x10 = {
    .width = 7,
    .height = 10,
    .first_char = 32,
    .last_char = 126,
...
uint8_t font_get_string_width(const char *str, uint8_t font_type, uint8_t scale)
{
    uint8_t width = 0;
    while (*str) {
        width += font_get_char_width(*str, font_type, scale);
        str++;
    }
    return width;
}
